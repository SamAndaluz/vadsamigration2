...
class HrPayslip(models.Model):
    ...
    def calculo_imss3(self, contract, worked_days, payslip, categories):
        ...
        # Invalidez y vida; Ausentismo/ F. injustificadas - Incapacidades
        inv_vida_esp_y_dinero = round(contract.tablas_cfdi_id.inv_vida_e, 3)
        _logger.info("Invalidez y  vida: " + str(inv_vida_esp_y_dinero))
        
        # Cesantia y veje
        ceav = round(contract.tablas_cfdi_id.cesantia_vejez_e, 3)
        _logger.info("Cesantia y vejez: " + str(ceav))
        
        
        enf_mat_en_dinero = round(contract.tablas_cfdi_id.enf_mat_prestaciones_e, 3)
        _logger.info("Prestaciones en efectivo: " + str(enf_mat_en_dinero))
        
        
        enf_mat_gastos_med_e = round(contract.tablas_cfdi_id.enf_mat_gastos_med_e, 3)
        _logger.info("Gastos medicos: " + str(enf_mat_gastos_med_e))
